...
public class ResponseClickDate extends FederationTagLibTagSupport {
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing Response for clickDate tag ");
	...
	public void setClickDate(Date clickDate) throws JspException {
		try {
			Response theResponse = (Response)findAncestorWithClass(this, Response.class);
